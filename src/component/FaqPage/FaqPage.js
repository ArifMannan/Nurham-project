            ...
            <div className="row justify-content-center">
              <div className="col-xl-6 col-lg-7">
                <div className="section-title white-color text-center mb-40">
                  <h2 className="title mb-10">Get A Free Quote</h2>
              ...
              <div className="col-lg-4 col-md-6 col-sm-8">
                <div className="service-item-eight mb-30">
                  <div className="service-img">
                    {" "}
                    <img
                      src="assets/img/service-img/07.jpg"
                      alt="Image"
                    />{" "}
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-8">
                <div className="service-item-eight mb-30">
                  <div className="service-img">
                    {" "}
                    <img
                      src="assets/img/service-img/08.jpg"
                      alt="Image"
                    />{" "}
                  </div>
                  <div className="services-overlay">
              ...
              <div className="col-lg-4 col-md-6 col-sm-8">
                <div className="service-item-eight mb-30">
                  <div className="service-img">
                    {" "}
                    <img
                      src="assets/img/service-img/09.jpg"
                      alt="Image"
                    />{" "}
                  </div>
                  <div className="services-overlay">
              ...
              <div className="col-lg-4 col-md-6 col-sm-8">
                <div className="service-item-eight mb-30">
                  <div className="service-img">
                    {" "}
                    <img
                      src="assets/img/service-img/11.jpg"
                      alt="Image"
                    />{" "}
                  </div>
                  <div className="services-overlay">
              ...
              <div className="col-lg-4 col-md-6 col-sm-8">
                <div className="service-item-eight mb-30">
                  <div className="service-img">
                    {" "}
                    <img
                      src="assets/img/service-img/12.jpg"
                      alt="Image"
                    />{" "}
                  </div>
                  <div className="services-overlay">
