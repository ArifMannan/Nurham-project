          ...
          <section className="blog-area section-gap">
            <div className="container">
              <div className="blog-grid-items row justify-content-center">
                <div className="col-lg-4 col-md-6 col-sm-8">
                  <div className="single-blog-grid mb-30">
                    ...
                    <div className="blog-grid-overlay">
                      <h5 className="title">
                        <a href="#">A series of iOS 7 inspired vector icons.</a>
                      </h5>
                ...
                <div className="col-lg-4 col-md-6 col-sm-8">
                  <div className="single-blog-grid mb-30">
                    <img src="assets/img/blog/blog-grid-10.jpg" alt="" />
                    <a className="cat" href="#">
                      Design/SEO
                    </a>
                    <div className="blog-grid-overlay">
                ...
                <div className="col-lg-4 col-md-6 col-sm-8">
                  <div className="single-blog-grid mb-30">
                    <img src="assets/img/blog/blog-grid-11.jpg" alt="" />
                    <a className="cat" href="#">
                      Design/SEO
                    </a>
                    <div className="blog-grid-overlay">
                ...
                <div className="col-lg-4 col-md-6 col-sm-8">
                  <div className="single-blog-grid mb-30">
                    <img src="assets/img/blog/blog-grid-12.jpg" alt="" />
                    <a className="cat" href="#">
                      Design/SEO
                    </a>
                    <div className="blog-grid-overlay">
