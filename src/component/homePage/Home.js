                ...
                <div className="row justify-content-center">
                  ...
                  >
                    <div className="service-item-four mt-50">
                      <div className="services-thumb">
                        <img
                          src="assets/img/service-img/01.jpg"
                          alt="Service-Image"
                        />
                      </div>
                      <div className="services-content">
                        ...
                        <p>
                          ...
                          voluptatem accusantium doloremque laudantiuto-tam rem
                  ...
                  >
                    <div className="service-item-four mt-50">
                      <div className="services-thumb">
                        <img
                          src="assets/img/service-img/02.jpg"
                          alt="Service-Image"
                        />
                      </div>
                      <div className="services-content">
                  ...
                  >
                    <div className="service-item-four mt-50">
                      <div className="services-thumb">
                        <img
                          src="assets/img/service-img/03.jpg"
                          alt="Service-Image"
                        />
                      </div>
                      <div className="services-content">
                  ...
                  >
                    <div className="service-item-four mt-50">
                      <div className="services-thumb">
                        <img
                          src="assets/img/service-img/04.jpg"
                          alt="Service-Image"
                        />
                      </div>
                      <div className="services-content">
                  ...
                  >
                    <div className="service-item-four mt-50">
                      <div className="services-thumb">
                        <img
                          src="assets/img/service-img/05.jpg"
                          alt="Service-Image"
                        />
                      </div>
                      <div className="services-content">
                  ...
                  >
                    <div className="service-item-four mt-50">
                      <div className="services-thumb">
                        <img
                          src="assets/img/service-img/06.jpg"
                          alt="Service-Image"
                        />
                      </div>
                      <div className="services-content">
